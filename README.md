...
Somos el grupo de los Alumnos: <br/>
1- África <br>
2- Rafael <br>
3- Álvaro <br>
4- Gabriel<br>
...
3- <a href="NumierTPV(Digitalización).mmd">Diagrama de Mermaid</a><br>
4- <a href="#transformacion digital">Transformacion digital</a><br>
5- <a href="#reflexion">Reflexión Final</a>
